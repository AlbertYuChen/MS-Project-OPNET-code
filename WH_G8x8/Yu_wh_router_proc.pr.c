...
const char Yu_wh_router_proc_pr_c [] = "MIL_3_Tfile_Hdr_ 171A 30A modeler 7 55392F8B 55392F8B 1 ECE-PHO309-01 chenyua 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 2b1a 1                                                                                                                                                                                                                                                                                                                                                                                                    ";
#include <string.h>
...
void load_ARnode_routing_table(void) {
	...
	sprintf(RName, "C:\\Users\\chenyua\\OPNET_Project\\WH_G8x8\\sim_data\\ARnode_%d.txt", This_Node_Number);  // <<<<--------------change work path here
...
void load_Rnode_routing_table(void) {
	...
	sprintf(RName, "C:\\Users\\chenyua\\OPNET_Project\\WH_G4x4\\sim_data\\Rnode_%d.txt", This_Node_Number);  // <<<<--------------change work path here
	if (!(Rinfile = fopen(RName, "r"))) {
