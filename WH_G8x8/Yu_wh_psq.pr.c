...
const char Yu_wh_psq_pr_c [] = "MIL_3_Tfile_Hdr_ 171A 30A modeler 7 55392F69 55392F69 1 ECE-PHO309-01 chenyua 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 2b1a 1                                                                                                                                                                                                                                                                                                                                                                                                    ";
#include <string.h>
...
void write_statistics_data(){
	...
	outfile = fopen("C:\\Users\\chenyua\\OPNET_Project\\WH_G8x8\\SimResult.txt","a");
	fprintf(outfile,"Curr_ETED_Ave: %.6e\n",Curr_ETED_Ave);
	fclose(outfile);
